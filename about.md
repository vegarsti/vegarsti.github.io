...
vegardstikbakke.com is hosted on [Netlify](https://www.netlify.com), and is generated with the Jekyll static site generator.
The source is [on Github](https://github.com/vegarsti/vegarsti.github.io).
The stylesheet is blatantly stolen from [Dan Romero](https://danromero.org).