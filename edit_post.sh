...
edit() {
    ...
    printf "Posts in directory of published posts $POSTS_DIR:\n"
    local MY_ARRAY=(`find "$POSTS_DIR" -name "*.md"`)
    local INDEX=0
    ...
    read -p "Edit which post? (0 to quit.) " CHOICE
